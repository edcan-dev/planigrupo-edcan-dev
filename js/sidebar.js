document.querySelector(".header__bars").onclick = function (ev) {
  if (document.querySelector("#sidebar-container").style.marginLeft != "0px") {
    ...
    document.querySelector(".navbar__responsive__list--second").style.left =
      "10%";
  }
};
...
try {
  document.querySelector("#nav__item--nosotros").onclick = function (ev) {
